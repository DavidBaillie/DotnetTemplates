...
#endif
using ExampleTemplate.Application.Extensions;
using ExampleTemplate.Domain.Constants;
using ExampleTemplate.Infrastructure.Extensions;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddInfrastructureServices(databaseOptions);
